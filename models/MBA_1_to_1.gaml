...
experiment MBA_1_to_1 type: gui {
	...
	parameter "Disturbance cycles" category: "Simulation settings" var: disturbance_cycles<- 2000#cycles; //500, 2000, 8000 -- amount of cycles until stations change their positions
